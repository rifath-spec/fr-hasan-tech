...
export const INITIAL_SERVICES: ServiceItem[] = [
  {
    ...
    category: "Photocopy",
    icon: "Copy",
    shortDescription: "Professional black & white and colour photocopy services.",
    ...
    image: "https://media.istockphoto.com/id/1337179160/photo/office-worker-print-paper-on-multifunction-laser-printer-copy-print-scan-and-fax-machine-in.jpg?s=612x612&w=0&k=20&c=-X45arkLvrEd37sF4_BGq0-2OBUo52JfxKXDxsfHb6A=",
  ...
  },
  {
    ...
    category: "Printing",
    icon: "Printer",
    shortDescription: "Quality document, colour, black & white and photo printing services.",
    ...
    image: "https://images.unsplash.com/photo-1612815154858-60aa4c59eaa6?auto=format&fit=crop&w=1600&q=80",
    availableServicesList: [
  ...
  },
  {
    ...
    category: "SIM Cards",
    icon: "Smartphone",
    shortDescription: "SIM cards from available mobile networks with current availability and pricing through the shop.",
    ...
    priceInfo: "Contact us / From LKR 350.00",
    image: "https://dailynews.lk/wp-content/uploads/2026/02/Untitled-124.jpg",
    availableServicesList: [
  ...
  },
  {
    ...
    category: "Packages",
    icon: "Package",
    shortDescription: "Mobile reloads, data packages, voice packages and other available mobile services.",
    ...
    image: "https://www.srilankalocaltours.com/wp-content/uploads/SIM-Card-Mobile-Network-Providers-in-Sri-Lanka.jpg",
    availableServicesList: [
